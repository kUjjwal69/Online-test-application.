...
namespace TestManagementApplication.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        // Delete the assigned test from a candidate
        [HttpDelete("tests/{testId:guid}/Unassign")]
        public async Task<IActionResult> UnassignTest(Guid testId, Guid UserId)
        {
        ...
        // get candidates using his id
        [HttpGet("id{userId}")]
        public async Task<ActionResult> GetCandidateById(Guid userId)
        {
            var users = await _adminService.GetCandidatesByIdAsync(userId);
            if(users == null)
            {
